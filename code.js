...
let locations = [
    {
        ...
        city: "MANALI",
        slug:"manali",
        image: "https://images.unsplash.com/photo-1648131877984-f39ebc1647f1?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bWFuYWxpfGVufDB8MXwwfHx8MA%3D%3D"
    },
    {
        state: "UTTARAKHAND",
        city: "RISHIKESH",
        slug:"rishikesh",
        image: "https://images.unsplash.com/photo-1718383538820-524dd564fd06?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8cmlzaGlrZXNofGVufDB8MXwwfHx8MA%3D%3D"
    },
    {
        state: "KASHMIR",
        city: "PAHALGAM",
        slug:"pahalgam",
        image: "https://images.unsplash.com/photo-1666545380922-1296a4ac9521?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8cGFoYWxnYW18ZW58MHwxfDB8fHww"
    },
    {
        state: "KERALA",
        city: "MUNNAR",
        slug:"munnar",
        image: "https://images.unsplash.com/photo-1628918098760-471c0fad230c?q=80&w=435&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    }
];
...
locations.forEach(function (place) {
    ...
    btn.addEventListener("click",function(){
        ...
        `destination.html?${place=locations.slug}`;
...
const articles = [
...

    {
        ...
        title: "Hidden Beaches That Feel Like Paradise",
        description:
...
readMoreButtons.forEach(function (button, index) {
    ...
    button.addEventListener("click", function () {
        window.location.href=`article.html?id=${articles.id}`
